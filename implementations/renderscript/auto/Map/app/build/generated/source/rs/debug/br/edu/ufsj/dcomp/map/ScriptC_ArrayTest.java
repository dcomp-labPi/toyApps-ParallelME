...
public class ScriptC_ArrayTest extends ScriptC {
    ...
    private final static int mExportForEachIdx_map1 = 1;
    public Script.KernelID getKernelID_map1() {
        return createKernelID(mExportForEachIdx_map1, 59, null, null);
    }

    public void forEach_map1(Allocation ain, Allocation aout) {
        forEach_map1(ain, aout, null);
    }

    public void forEach_map1(Allocation ain, Allocation aout, Script.LaunchOptions sc) {
        // check ain
        ...
        forEach(mExportForEachIdx_map1, ain, aout, null, sc);
    }
