...
public class ScriptC_operation extends ScriptC {
    ...
    private final static int mExportForEachIdx_map = 1;
    public Script.KernelID getKernelID_map() {
        return createKernelID(mExportForEachIdx_map, 59, null, null);
    }

    public void forEach_map(Allocation ain, Allocation aout) {
        forEach_map(ain, aout, null);
    }

    public void forEach_map(Allocation ain, Allocation aout, Script.LaunchOptions sc) {
        // check ain
        ...
        forEach(mExportForEachIdx_map, ain, aout, null, sc);
    }
