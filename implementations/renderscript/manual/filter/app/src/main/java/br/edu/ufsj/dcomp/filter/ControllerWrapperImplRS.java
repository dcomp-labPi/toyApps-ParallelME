...
public class ControllerWrapperImplRS implements ControllerWrapper {
	...
	private boolean PM_array7FromImage = false;
	private Allocation PM_result10Out;
	private boolean PM_result10FromImage = false;
	...
	public void filter1(int sizeIn) {
		...
		PM_kernel.set_PM_gSizeInFilter1(sizeIn);
